...
To configure tests, download the repo from git hub "https://github.com/boggarapu2017/seleniumJavaTestNg"
...
Add external jar files to the project(Right click on the project-->BuildPath-->ConfigureBuild Path-->in Libraries add external jars). Jars are placed in Jars folder under the project.
